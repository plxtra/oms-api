---
title: Order Management System Views
sidebar:
...
* **Updates**: Low-Level view of all open and recently expired Orders, and actions that affect them.
...
An Update generates Events, which describe high-level changes to an OMS view, such as a change in cash balance, a change in available holdings, a change to Order status.
...
* **Transactions**: A new [ClientTransaction](../../proto/updates/#clienttransaction) event will be sent, describing the changes to cash and holdings that occurred.
* **Updates**: A new [ExternalAction](../../proto/updates/#externalaction) event will be sent, describing the full details of the trade that occurred.
